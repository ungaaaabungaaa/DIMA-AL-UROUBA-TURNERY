  ...
  return (
   ...
   <div className='hero_contact'>
    <div className='hero_contact_section'>
      <div class="Email">
        <p onClick={handleEmailClick}>sales@dimaalouroba.com </p>
      ...
      <div class="Contact">
        <p onClick={handlePhoneClick}>+966 582444166</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="1.4rem" height="1.4rem" viewBox="0 0 24 24">
      ...
      <div class="whats-app">
        <p onClick={handleWhatsAppClick}>+966 5099096620</p>
        <svg xmlns="http://www.w3.org/2000/svg" width="1.4rem" height="1.4rem" viewBox="0 0 24 24">
      ...
      <div class="Location">
        <p onClick={handleLocationClick}>Location</p>
      </div>
    </div>
   </div>
