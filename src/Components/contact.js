    ...
    return (
      ...
      <h1 className='h1_Contact'>Do You Have Any Questions? <br></br>
        ...
        <div className='contact_us_highlight'>
            ...
            <svg className='margin_right contact_us_icon' xmlns="http://www.w3.org/2000/svg" width="1.4rem" height="1.4rem" viewBox="0 0 24 24">
              ...
              <p className='contact_us_text'>Chat live On Whats App | الدردشة المباشرة على تطبيق واتس اب</p>
            </div>
            <br></br>
            <div className='highlight'>
              <svg className='margin_right contact_us_icon' xmlns="http://www.w3.org/2000/svg" width="1.4rem" height="1.4rem" viewBox="0 0 24 24">
